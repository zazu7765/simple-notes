<script>
  ...
  <header class="bg-indigo-500 content-center">
  <form class="dark:bg-black content-center ">
    <label for="editor" class="sr-only content-center pl-20">Publish post</label>
   
      <Toolbar slot="header" class="rounded-md">
        <ToolbarGroup>
          <ToolbarButton name="Attach file"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 bg-indigo-500"><path stroke-linecap="round" stroke-linejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941l-7.81 7.81a1.5 1.5 0 002.112 2.13" /></svg></ToolbarButton>
        ...
        <ToolbarGroup>
          <ToolbarButton name="Format code"><svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" /></svg></ToolbarButton>
      ...
      <Textarea id="editor" rows="8" class="mb-4 dark:bg-black  rounded-md max-w-[50%] content-center" placeholder="Write a comment"/>
    </div>
